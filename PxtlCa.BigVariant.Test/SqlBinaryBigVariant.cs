...
{
    [TestClass()]
    public class SqlBinaryBigVariant : SqlDatabaseTestClass
    {

        public SqlBinaryBigVariant()
        {
            InitializeComponent();
        }
        ...
        {
            SqlDatabaseTestActions testActions = this.LargeBinaryIntoBigVariantData;
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.LargeBinaryIntoBigVariantData.PosttestAction = null;
            this.LargeBinaryIntoBigVariantData.PretestAction = null;
            this.LargeBinaryIntoBigVariantData.TestAction = LargeBinaryIntoBigVariant_TestAction;
            // 
            // LargeBinaryIntoBigVariant_TestAction
            // 
            LargeBinaryIntoBigVariant_TestAction.Conditions.Add(notEmptyResultSetCondition1);
            resources.ApplyResources(LargeBinaryIntoBigVariant_TestAction, "LargeBinaryIntoBigVariant_TestAction");
            // 
